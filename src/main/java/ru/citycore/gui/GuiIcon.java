...
public enum GuiIcon {
    ...
    COMMUNICATIONS(Material.PAPER, "b4bd9dd128c94c10c945eadaa342fc6d9765f37b3df2e38f7b056dc7c927ed"),
    PHONE(Material.CLOCK, null),
    CALL(Material.GOAT_HORN, null),
    RADIO(Material.ECHO_SHARD, "7243bebf61cc5c4ae45387521fc37fead106cd0be780115b8ae790af8db8b3c0"),
    SETTINGS(Material.COMPARATOR, null),
    MARKET(Material.EMERALD, null),
    PROPERTY(Material.OAK_DOOR, null),
    CONTRACTS(Material.WRITABLE_BOOK, null),
    ORDERS(Material.CHEST_MINECART, null),
    ORGANIZATION(Material.ARMOR_STAND, null),
    SERVICES(Material.REDSTONE_TORCH, null),
    LAW(Material.IRON_SWORD, null),
    ...
    DIRECTORY(Material.FILLED_MAP, null),
    STATISTICS(Material.KNOWLEDGE_BOOK, null),
    ...
    ACCOUNT(Material.GOLD_INGOT, null),
